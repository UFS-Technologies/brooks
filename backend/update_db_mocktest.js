...
async function run() {
    ...
    try {
        await connection.promise().query("ALTER TABLE student ADD COLUMN Mock_Test_Subscribed TINYINT(1) DEFAULT 0");
        console.log("Added Mock_Test_Subscribed");
    } catch (e) {
        if(e.code === 'ER_DUP_FIELDNAME') console.log("Mock_Test_Subscribed already exists");
        else throw e;
    }

    try {
        await connection.promise().query("ALTER TABLE student ADD COLUMN Mock_Test_Package VARCHAR(100) DEFAULT NULL");
        console.log("Added Mock_Test_Package");
    } catch (e) {
        if(e.code === 'ER_DUP_FIELDNAME') console.log("Mock_Test_Package already exists");
        else throw e;
    }
...
CREATE PROCEDURE Save_student( 
    ...
    IN Registration_No_ VARCHAR(50),
    IN Registered_On_ datetime,
    IN Mock_Test_Subscribed_ TINYINT,
    IN Mock_Test_Package_ VARCHAR(100)
)
BEGIN
    ...
    main_block: BEGIN
        ...
        IF Student_ID_ > 0 THEN
            ...
            SET First_Name = First_Name_,
                ...
                Mock_Test_Subscribed = Mock_Test_Subscribed_,
                Mock_Test_Package = Mock_Test_Package_
        ...
        ELSE
            ...
            INSERT INTO student (
                ...
                Mock_Test_Subscribed, Mock_Test_Package
            )
            VALUES (
                ...
                Mock_Test_Subscribed_, Mock_Test_Package_
            );
...
END
    ...
    try {
        await connection.promise().query(spQuery);
        console.log("SP updated");
    } catch (e) {
        console.error("Failed to update SP:", e);
    }
    process.exit(0);
}
run();
